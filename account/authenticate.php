...
<head>
    <title>Authenticate :: Internet Banking - Sterling Unity Bank</title>
                ...
                <div class="bg-light rounded">
                    ...
                    <form class="p-4 mt-2" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <p class="font-weight-bold"><?= $user->question; ?></p>

                            <input type="password" name="answer" id="id" class="form-control" required autofocus>

                            <span class="help-block text-danger"><?= $user->ans_error; ?></span>

                        </div>
                        <div class="my-4 d-grid">

                            <button type="submit" name="chkans" class="btn btn-outline-purple rounded">Submit</button>
