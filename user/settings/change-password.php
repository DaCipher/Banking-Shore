...
<head>
    <title>Change Password - Financial Shore Online Banking</title>
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <form action="" method="post" class="my-2" id="pass-form">
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="mb-3">
                                                        <input class="form-control" type="password" name="current_pass" id="current_pass" placeholder="Current Password" required>
                                                        <span class="span help-block text-danger" id="current_pass_error"><?= $user->current_pass_error; ?></span>
                                                    </div>
                                                    <div class="mb-3">
