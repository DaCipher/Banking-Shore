...
<head>
    <title>Update User Status - Financial Shore Admin</title>
                                                            ...
                                                            <form action="" method="post">
                                                                <td>
                                                                    ...
                                                                    <select name="status" id="" class="form-control">
                                                                        ...
                                                                        <option value="active" <?= ($users['account_status'] == "active") ? "selected" : ""; ?>> Active</option>
                                                                        <option value="domant" <?= ($users['account_status'] != "active") ? "selected" : ""; ?>> Domant</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select name="restriction" id="" class="form-control">
                                                                        <option value="" disabled> select restriction </option>
                                                                        <option value="blocked" <?= ($users['account_restriction'] == "blocked") ? "selected" : ""; ?>> Blocked</option>
                                                                        <option value="freezed" <?= ($users['account_restriction'] == "freezed") ? "selected" : ""; ?>> Freezed</option>
                                                                        <option value="locked" <?= ($users['account_restriction'] == "locked") ? "selected" : ""; ?>> Locked</option>
                                                                        <option value="open" <?= ($users['account_restriction'] == "open" || empty($users['account_restriction'])) ? "selected" : ""; ?>> Open</option>
                                                                    </select>
                                                                </td>
                                                                <td>
