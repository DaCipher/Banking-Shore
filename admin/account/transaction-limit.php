...
<head>
    <title>Update Transaction Limits - Financial Shore ADMIN</title>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-8 col-lg-12">
                            <div class="card mb-4 px-2">
                                <div class="card-body">
                                    <div class="mb-4 px-2">
                                        <div style="font-size: 0.9rem;">Current Daily Limit: <strong>$ <?= number_format($user->user['daily_limit']); ?></strong> </div>
                                        <div style="font-size: 0.9rem;">Current Limit Per Transaction: <strong>$ <?= number_format($user->user['transaction_limit']); ?></strong> </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div>Please contact <span style="font-weight: bold; cursor:pointer" onclick="location.assign('mailto:customersupport@financialshore.com')">customersupport@financialshore.com</span> with the following documents:</b>
                                <ul>
