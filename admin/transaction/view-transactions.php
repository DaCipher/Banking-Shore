...
<head>
    <title>Manage User Transactions - Financial Shore ADMIN</title>
                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" id="account-history" class="mb-4" method="get">
                                        ...
                                        <?php if (isset($_GET['account'])) :; ?>
                                            <div class="px-4 py-5 d-flex justify-content-center align-items-center" style="height: 290px;">
                                                <div class="text-center">
                                                    ...
                                                    <p style="font-size: 1.5rem;"> No transaction found!</p>
